...
public class ExercicioL_while_parte3 {
...
// </editor-fold>
		...
		*/
		...
		Integer numLido = readInteger("Digite um número para calcular o Fatorial");
		
		Integer contReverso = numLido;
		Integer limite = 1;
		Integer fatorial = 1;
		
		if (numLido >= 0) {
			while (contReverso >= limite ) {
				fatorial = fatorial * contReverso;
	//			write("contReverso: " + contReverso);
