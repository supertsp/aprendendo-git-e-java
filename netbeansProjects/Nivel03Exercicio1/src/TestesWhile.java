...
//		Integer qtdEstrelas = readInteger("Quantas estrelas vc quer ver? Limite min: 1; Limite max: 5");
		Integer qtdEstrelas = readInteger("Quantas estrelas vc quer ver?");
		
		String estrelas = "";		
		//iniciar: 0; terminar: nº digitado -1
		//contador		
		Integer cont = 0;
		...
		while (cont < qtdEstrelas) {
			cont = cont + 1;
			estrelas = estrelas + "*";
//			estrelas = estrelas + cont;
		}
		
		write(estrelas);
		
		
//		if (qtdEstrelas >= 1 && qtdEstrelas <= 5) {
//			if (qtdEstrelas == 1) {
//				estrelas = "*";
//			}
//			
...
//		}
//		else{
//			write("Que pena... vc digitou um valor inválido :(");
//		}
