...
public class TestesNivel02ParteA {

	public static void main(String[] args) {
// </editor-fold>
		// Your code starts here :)
		
		Integer idadePessoaQueQuerEntrar = readWindowInteger("(Parte A) Qual é a sua idade?");
