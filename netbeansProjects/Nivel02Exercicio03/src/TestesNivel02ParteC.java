...
// </editor-fold>
		...
		/*
		Temos um acampamento para famílias
		Lá as pessoas serão separadas por quartos baseados em suas idades:
			1 > 0 a 3   ==> , você irá para:\n Berçário Feliz
			2 > 4 a 10  ==> , você irá para:\n Galera Free Style
			3 > 11 a 15 ==> , você irá para:\n Padwan
			4 > 16 a 18 ==> , você irá para:\n Jedi
			5 > 19 a 30 ==> , você irá para:\n Sith
			6 > 31 a 50 ==> , você irá para:\n Águias
			7 > 51 a 70 ==> , você irá para:\n La Bambas
		
		Obs.: os menores que 0 e maiores que 70 são proibidos.
		*/
		
		final String CABECALHO = 
				"+---------------------------+\n" +
				"| ACAMPAMENTO DE VERÃO 2022 |\n" +
				"+---------------------------+\n"
		;
		...
		if (idade < 0 || idade >= 70) {
			auxMensagem += "Ops... Infelizmente esse acampamento não foi projetado para você :(";
		}
		else {
			auxMensagem += nome + ", você irá para:\n ";			
		}	
		
		//faixa numérica inclusiva
		if (idade >= 0 && idade <= 3) {
			auxMensagem += "Berçário Feliz";
		}
		
		if (idade >= 4 && idade <= 10) {
			auxMensagem += "Galera Free Style";
		}
